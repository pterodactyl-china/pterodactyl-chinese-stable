        ...
        <div class="box box-primary">
            ...
            <form action="{{ route('admin.servers.view.details', $server->id) }}" method="POST">
                ...
                <div class="box-footer">
                    {!! csrf_field() !!}
                    {!! method_field('PATCH') !!}
                    <input type="submit" class="btn btn-sm btn-primary" value="应用更改" />
                </div>
            </form>
        </div>
    </div>
    ...
    $('#pUserId').select2({
        ...
        templateResult: function (data) {
            ...
            return '<div class="user-block"> \
                <img class="img-circle img-bordered-xs" src="https://gravatar.loli.net/avatar/' + escapeHtml(data.md5) + '?s=120" alt="User Image"> \
                <span class="username"> \
        ...
        templateSelection: function (data) {
            ...
            return '<div> \
                <span> \
                    <img class="img-rounded img-bordered-xs" src="https://gravatar.loli.net/avatar/' + escapeHtml(data.md5) + '?s=120" style="height:28px;margin-top:-4px;" alt="User Image"> \
                </span> \
